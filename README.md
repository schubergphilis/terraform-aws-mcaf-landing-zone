...
| <a name="input_aws_inspector"></a> [aws\_inspector](#input\_aws\_inspector) | AWS Inspector settings | <pre>object({<br>    enabled                 = optional(bool, false)<br>    auto_enable_ec2         = optional(bool, true)<br>    auto_enable_ecr         = optional(bool, true)<br>    auto_enable_lambda      = optional(bool, true)<br>    auto_enable_lambda_code = optional(bool, true)<br>  })</pre> | <pre>{<br>  "auto_enable_ec2": true,<br>  "auto_enable_ecr": true,<br>  "auto_enable_lambda": true,<br>  "auto_enable_lambda_code": true,<br>  "enabled": false<br>}</pre> | no |
